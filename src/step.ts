...
When('the {string} service does {string} in the {string} process with {scalar}', (system, action, process, response) => actorDoes(`service:${system}`, action, process, response));
When('the {string} service does {string} in the {string} process with:', (system, action, process, response) => actorDoes(`service:${system}`, action, process, parseData(response)));
When('the {string} service does {string} in the {string} process', (system, action, process) => actorDoes(`service:${system}`, action, process));
When('the {string} service does {string} with {scalar}', (system, action, response) => actorDoes(`service:${system}`, action, 'main', response));
When('the {string} service does {string} with:', (system, action, response) => actorDoes(`service:${system}`, action, 'main', parseData(response)));
